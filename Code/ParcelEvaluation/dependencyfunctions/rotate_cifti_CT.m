function rotated_maps = rotate_cifti_CT(cifti_tobe_rotated,premade_rotations_cifti,baddata_cifti,outfilename)
...
load(premade_rotations_cifti,'all_rot_verts');
rotations.data = all_rot_verts;
...
A = class(map_tobe_rotated.data);eval(['rotated_maps = ',A,'(rotated_maps);']);
